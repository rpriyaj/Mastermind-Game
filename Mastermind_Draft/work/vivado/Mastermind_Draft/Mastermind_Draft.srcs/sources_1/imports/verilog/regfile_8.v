...
module regfile_8 (
    ...
    output reg [4:0] rc_addr,
    output reg [15:0] rc_data,
    output reg [0:0] we_signal
  );
  ...
  reg [15:0] M_reg_current_colour_d, M_reg_current_colour_q = 2'h2;
  
  reg [3:0] M_reg_current_guess_count_d, M_reg_current_guess_count_q = 4'h8;
  
  reg [15:0] M_reg_game_mode_d, M_reg_game_mode_q = 1'h0;
  
  reg [15:0] M_reg_code_d, M_reg_code_q = 15'h4627;
  
  reg [15:0] M_reg_code_helper_d, M_reg_code_helper_q = 16'hf000;
  
  reg [15:0] M_reg_guess_d, M_reg_guess_q = 16'h2222;
  
  reg [15:0] M_reg_guess_helper_d, M_reg_guess_helper_q = 16'hf000;
  ...
  reg [15:0] M_reg_temp_counter_d, M_reg_temp_counter_q = 1'h1;
  
  reg [15:0] M_reg_imposter_d, M_reg_imposter_q = 2'h3;
  
  reg [15:0] M_reg_error_d, M_reg_error_q = 16'h2222;
  
  reg [15:0] M_reg_temp_d, M_reg_temp_q = 1'h0;
  
  reg [15:0] M_reg_xor_d, M_reg_xor_q = 16'hf000;
  
  reg [15:0] M_reg_led_colour_d, M_reg_led_colour_q = 16'h3333;
  
  always @* begin
    M_reg_current_guess_count_d = M_reg_current_guess_count_q;
    M_reg_imposter_d = M_reg_imposter_q;
    M_reg_led_colour_d = M_reg_led_colour_q;
    M_reg_guess_helper_d = M_reg_guess_helper_q;
    M_reg_xor_d = M_reg_xor_q;
    ...
    if (we) begin
      ...
      case (rc)
        ...
        4'hf: begin
          M_reg_temp_d = wr_data;
        end
        5'h10: begin
          M_reg_xor_d = wr_data;
        end
        5'h11: begin
          M_reg_led_colour_d = wr_data;
        end
      endcase
    end
    ...
    case (ra)
      ...
      4'hf: begin
        ra_data = M_reg_temp_q;
      end
      5'h10: begin
        ra_data = M_reg_xor_q;
      end
      5'h11: begin
        ra_data = M_reg_led_colour_q;
      end
      default: begin
        ra_data = 16'h0000;
      end
    ...
    case (rb)
      ...
      4'hf: begin
        rb_data = M_reg_temp_q;
      end
      5'h10: begin
        rb_data = M_reg_xor_q;
      end
      5'h11: begin
        rb_data = M_reg_led_colour_q;
      end
      default: begin
        rb_data = 16'h0000;
      end
    ...
    case (rc)
      ...
      4'hf: begin
        rc_data = M_reg_temp_q;
      end
      5'h10: begin
        rc_data = M_reg_xor_q;
      end
      5'h11: begin
        rc_data = M_reg_led_colour_q;
      end
      default: begin
        rc_data = 16'h0000;
      end
  ...
  always @(posedge clk) begin
    if (rst == 1'b1) begin
      M_reg_xor_q <= 16'hf000;
    end else begin
      M_reg_xor_q <= M_reg_xor_d;
    end
  end
  ...
  always @(posedge clk) begin
    if (rst == 1'b1) begin
      M_reg_current_guess_count_q <= 4'h8;
    end else begin
  ...
  always @(posedge clk) begin
    if (rst == 1'b1) begin
      M_reg_led_colour_q <= 16'h3333;
    end else begin
      M_reg_led_colour_q <= M_reg_led_colour_d;
    end
  end
